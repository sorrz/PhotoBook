namespace PhotoBook
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("We are now gonna run a test for different size PhotoBooks");
            Console.WriteLine("1.   To make a standard PhotoBook (16), from the default constructor");
